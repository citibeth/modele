E_AR5_V2_CADI.R GISS Model E  1850 ocn/atm     Larissa    07/15/2014

E_AR5_V2_CADI is for AR5_V2 Prime production runs;
...
E_AR5_V2_CADI (E_AR5_CADI + U00a=0.60; U00b=1.0; CMTN=0.1; CDEF=1.6)
