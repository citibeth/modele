E_AR5_CAMP.R GISS Model E  1850 ocn/atm     Larissa    10/12/2010

E_AR5_CAMP: E_AR5_CAD + computed aerosol 1st indirect effect MATRIX aerosol microphysics;
            U00a=0.72, U00b=1.00, WMUI_multiplier = 2.
...
E_AR5_CAMP (MATRIX aerosol microphysics)
...
NRAD=1           ! radiation (every NRAD'th physics time step)
#include "diag_params"

Nssw=2           ! until diurnal diags are fixed, Nssw has to be even
Ndisk=960
KCOPY=1		 ! 1= not saving rsf 
&&END_PARAMETERS
