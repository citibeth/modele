E4TTOMASF40_MERRA GISS Model E  1850 ocn/atm   YUNHA LEE  10/2011

E4TTOMASF40_MERRA:  E4TcadF40 with TOMAS aerosol microphysics + nudged with MERRA
...
#define MERRA_NUDGING            ! nudging to use 
...
#include "MERRA_nudging_144x89_input_files"

MSU_wts=MSU.RSS.weights.data      ! MSU-diag
REG=REG2X2.5                      ! special regions-diag

Label and Namelist:  (next 2 lines)
E4TTOMASF40_MERRA (E4F40 with aerosol, chemistry, and dust tracers)
...
&&END_PARAMETERS
 ...
 YEARE=2002,MONTHE=5,DATEE=2,HOURE=0,     KDIAG=12*0,9,
