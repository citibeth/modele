E4F40iEnt.R GISS Model E  1850 ocn/atm          Larissa        08/26/2010

E4F40iEnt: rundeck for running GCM coupled to interactive
       Dynamic Vegatation (Ent). In this version Ent uses its own
...
E4F40iEnt (NIsurf=2; NetCDF output; WMUI_multiplier=2.) 
...
! atmCO2=368.6          !uatm for year 2000 - enable for CO2 tracer runs
do_phenology_activegrowth = 1 !0-false (default) & 1-true
&&END_PARAMETERS
