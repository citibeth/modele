E_AR5_V2_NINT_oR.R GISS Model E  coupled version          larissa   07/18/2014

E_AR5_V2_NINT_oR is for AR5 Prime production runs: 
...
E_AR5_V2_NINT_oR (E_AR5_NINT_oR + U00a=0.63; WMUI_multiplier=1.; U00b=1.0; CMTN=0.1; CDEF=1.6)
