E1fzhyc.R GISS Model E  2007 modelE                 ssun  12/6/07

E1fzhyc: modelE equiv to frozen version, coupled to hycom ocean model
...
RAD_COM RAD_DRV_E1 RADIATION_E1 READ_AERO     ! radiation modules
