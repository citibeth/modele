E_AR5_CAD_oR.R GISS Model E  1850 ocn/atm/tracers  Larissa   10/13/2010

E_AR5_CAD_oR: E_AR5_CAD coupled to 1x1.25deg 32-layer GISS ocean model
...
E_AR5_CAD_oR (E_AR5_NINT + chem.,aer.,dust tracers + Q32 Ocean R)
