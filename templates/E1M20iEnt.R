E1M20iEnt GISS Model E  2004 modelE                 rar 12/01/03

E1M20iEnt: rundeck for running GCM coupled to interactive
       Dynamic Vegatation (Ent). In this mode Ent uses its own
       16 pfts and runs with prognostic phenology (LAI).
...
MODEL_COM GEOM_B IO_DRV ! IORSF              ! model variables and geometry
...
GIC=GIC.E046D3M20A.1DEC1955.ext.nc
...
LAIent=LAIent.global_simple
HITEent=HITEent.global_simple

Label and Namelist:
E1M20iEnt (ModelE1 4x5, 20 lyrs, 1880 atm/ocn; use up to 72 (or 80) columns and ??
