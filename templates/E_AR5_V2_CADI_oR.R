E_AR5_V2_CADI_oR.R GISS Model E  1850 ocn/atm/tracers  Larissa   05/14/2014

E_AR5_V2_CADI_oR is for AR5 Prime TCADI production runs: 
...
TOPO=Z2HX2fromZ1QX1N.BS1            ! atm-grid surface fractions and topography
...
E_AR5_V2_CADI_oR (E_AR5_CADI_oR + U00a=0.65; WMUI_multiplier=1.; U00b=1.0; CMTN=0.1; CDEF=1.6)
