...
!@ver  1.0
     ...
     &     ,sname_strlen,units_strlen,lname_strlen
      ...
      IMPLICIT NONE
      SAVE
      INTEGER, PARAMETER :: KOIJ=93,KOL=6,KOLNST=8
      INTEGER, PARAMETER :: KOIJL=34
...
!@var IJ_xxx Names for OIJ diagnostics
     ...
     *     ,IJ_MRVR,IJ_EICB,IJ_MICB,IJ_GMSC,IJ_GMSCz
...
!@var ij_pCO2 surface ocean partial CO2 pressure
     ...
     .           ,ij_DICrhs1,ij_DICrhs2,ij_DICrhs3
     .           ,ij_DICrhs4,ij_DICrhs5,ij_DICrhs6,ij_xchl   
     .           ,ij_pp1,ij_pp2,ij_pp3,ij_pp4
     .           ,ijl_avgq,ij_pH,ij_co3
...
!@var IJL_xxx Names for OIJL diagnostics
     ...
     *     ,IJL_MFUB,IJL_MFVB,IJL_MFWB,IJL_KVX,IJL_ISDM
#ifdef OCN_Mesoscales
...
c
      ...
      k=k+1
      IJ_NITrhs1=k
      lname_oij(k)="NIT rhs1"
      sname_oij(k)="oij_NITrhs1"
      units_oij(k)="mili-molN/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1

      k=k+1
      IJ_NITrhs2=k
      lname_oij(k)="NIT rhs2"
      sname_oij(k)="oij_NITrhs2"
      units_oij(k)="mili-molN/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NITrhs3=k
      lname_oij(k)="NIT rhs3"
      sname_oij(k)="oij_NITrhs3"
      units_oij(k)="mili-molN/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NITrhs4=k
      lname_oij(k)="NIT rhs4"
      sname_oij(k)="oij_NITrhs4"
      units_oij(k)="mili-molN/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NITrhs5=k
      lname_oij(k)="NIT rhs5"
      sname_oij(k)="oij_NITrhs5"
      units_oij(k)="mili-molN/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NITrhs6=k
      lname_oij(k)="NIT rhs6"
      sname_oij(k)="oij_NITrhs6"
      units_oij(k)="mili-molN/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_AMMrhs1=k
      lname_oij(k)="AMM rhs1"
      sname_oij(k)="oij_AMMrhs1"
      units_oij(k)="mili-molN/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_chlrhs1=k
      lname_oij(k)="chl rhs1"
      sname_oij(k)="oij_chlrhs1"
      units_oij(k)="mili-gr,chl/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1

      k=k+1
      IJ_chlrhs2=k
      lname_oij(k)="chl rhs2"
      sname_oij(k)="oij_chlrhs2"
      units_oij(k)="mili-gr,chl/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_chlrhs3=k
      lname_oij(k)="chl rhs3"
      sname_oij(k)="oij_chlrhs3"
      units_oij(k)="mili-gr,chl/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_chlrhs4=k
      lname_oij(k)="chl rhs4"
      sname_oij(k)="oij_chlrhs4"
      units_oij(k)="mili-gr,chl/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_chlrhs5=k
      lname_oij(k)="chl rhs5"
      sname_oij(k)="oij_chlrhs5"
      units_oij(k)="mili-gr,chl/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_HERBrhs1=k
      lname_oij(k)="HERB rhs1"
      sname_oij(k)="oij_herbrhs1"
      units_oij(k)="mili-gr,chl/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_HERBrhs2=k
      lname_oij(k)="HERB rhs2"
      sname_oij(k)="oij_herbrhs2"
      units_oij(k)="mili-gr,chl/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NDETrhs1=k
      lname_oij(k)="NDET rhs1"
      sname_oij(k)="oij_ndetrhs1"
      units_oij(k)="mili-gr,N/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1

      k=k+1
      IJ_NDETrhs2=k
      lname_oij(k)="NDET rhs2"
      sname_oij(k)="oij_ndetrhs2"
      units_oij(k)="mili-gr,N/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NDETrhs3=k
      lname_oij(k)="NDET rhs3"
      sname_oij(k)="oij_ndetrhs3"
      units_oij(k)="mili-gr,N/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NDETrhs4=k
      lname_oij(k)="NDET rhs4"
      sname_oij(k)="oij_ndetrhs4"
      units_oij(k)="mili-gr,N/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_NDETrhs5=k
      lname_oij(k)="NDET rhs5"
      sname_oij(k)="oij_ndetrhs5"
      units_oij(k)="mili-gr,N/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_DICrhs6=k
      lname_oij(k)="DIC rhs6"
      sname_oij(k)="oij_DICrhs6"
      units_oij(k)="mili-molC/hr"
      ia_oij(k)=ia_src
      scale_oij(k)=1
      ...
      k=k+1
      IJ_GMSC=k
      lname_oij(k)='Mesoscale diffusivity at surface'
      sname_oij(k)='K_meso'
      units_oij(k)='m2/s'
      ia_oij(k)=ia_src
      scale_oij(k)=1.
...
c
     ...
     &       make_timeaxis=make_timeaxis)
        ...
        call add_var(cdl_toijl,
     &       'float '//trim(sname_toijl(kk))//trim(xyzstr),
     &       long_name='GM/EDDY DOWNWARD VERT. FLUX '//trim(trname(nt)),
     &       units=trim(unitstr),
     &       make_timeaxis=make_timeaxis)
