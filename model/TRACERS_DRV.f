...
!@auth J. Lerner
!@calls sync_param, SET_TCON, RDLAND, RDDRYCF,RDISOPCF,RDISOBASE
...
c         HSTAR(n)=tr_RKD(n)*convert_HSTAR
      ...
      n_OCII = n
          ntm_power(n) = -11
          ntsurfsrc(n) = 2 !industrial+terpene emissions    
          tr_mm(n) = 15.6
      ...
      n_OCA4 = n
          ...
          fq_aer(n)=1.   !fraction of aerosol that dissolves
          tr_wd_TYPE(n) = nPART        
      case ('OCB') !biomass burning organic mass
      n_OCB = n
          ntm_power(n) = -11
          ntsurfsrc(n) = 0    
          tr_mm(n) = 15.6
...
! keep AIJ and AJL CO2 sources in same order !!
     ...
     &  'CHANGE OF '//trname(n)//' BY OVERWRITE'
        ...
        lname_jls(k) = 'CHANGE OF N2O BY RESETTING TO 462.2d-9, L1'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
      ...
      case ('CH4')
        ...
        k = k + 1
        jls_source(1,n) = k
        sname_jls(k) = 'E95_Animal_source_'//trname(n)
        lname_jls(k) = 'CH4 E95 Animal source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(2,n) = k
        sname_jls(k) = 'E95_Fos_Fuel_source_'//trname(n)
        lname_jls(k) = 'CH4 E95 Fossil Fuel source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        ...
        lname_jls(k) = 'CH4 E95 Waste handling source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(4,n) = k
        sname_jls(k) = 'E95_Animal_waste_'//trname(n)
        lname_jls(k) = 'CH4 E95 Animal waste management source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(5,n) = k
        sname_jls(k) = 'E95_Ag_waste__'//trname(n)
        lname_jls(k) = 'CH4 E95 Agricultural Waste Burning source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(8,n) = k
        sname_jls(k) = 'E95_Rice_cultiv_'//trname(n)
        lname_jls(k) = 'CH4 E95 Rice cultivation source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(12,n) = k
        sname_jls(k) = 'E95_bio_burn_source_'//trname(n)
        lname_jls(k) = 'CH4 E95 Biomass Burning source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(13,n) = k
        sname_jls(k) = 'E95_Biofuel_source_'//trname(n)
        lname_jls(k) = 'CH4 E95 Biofuel source'
        jls_ltop(k) = 1
        jls_power(k) = 0
        units_jls(k) = unit_string(jls_power(k),'kg/s')
#else
...
C**** special one unique to HTO
      ...
      case ('NOx')
        ...
        jls_3Dsource(nStratwrite,n) = k
        sname_jls(k) = 'overwrite_source_of'//trname(n)
        lname_jls(k) = 'CHANGE OF NOx BY OVERWRITE'
        jls_ltop(k) = LM
        jls_power(k) = 0.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        ...
        lname_jls(k) = 'NOx E95 fossil fuel source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        ...
        lname_jls(k) = 'NOx E95 Industrial Processes source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(3,n) = k
        sname_jls(k) = 'E95_Waste_hl_source_'//trname(n)
        lname_jls(k) = 'NOx E95 Waste Handling source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        ...
        lname_jls(k) = 'NOx E95 Biofuel source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        ...
        lname_jls(k) = 'NOx E95 Agricultural Waste Burning source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        ...
        lname_jls(k) = 'NOx E95 Biomass burning source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
     ...
     &  'CHANGE OF '//trname(n)//' BY OVERWRITE'
       ...
       case ('CO')
        ...
        jls_3Dsource(nStratwrite,n) = k
        sname_jls(k) = 'overwrite_source_of'//trname(n)
        lname_jls(k) = 'CHANGE OF CO BY OVERWRITE'
        jls_ltop(k) = LM
        jls_power(k) = 0.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
#ifdef EDGAR_HYDE_SOURCES
        ...
        jls_source(1,n) = k
        sname_jls(k) = 'E95_Fos_Fuel_Source_of_'//trname(n)
        lname_jls(k) = 'CO E95 fossil fuel source'
        jls_ltop(k) = 1
        jls_power(k) = -1.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(2,n) = k
        sname_jls(k) = 'E95_Industrial_Source_of_'//trname(n)
        lname_jls(k) = 'CO E95 Industrial Processes source'
        jls_ltop(k) = 1
        jls_power(k) = -1.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(3,n) = k
        sname_jls(k) = 'E95_Waste_hl_source_'//trname(n)
        lname_jls(k) = 'CO E95 Waste Handling source'
        jls_ltop(k) = 1
        jls_power(k) = -1.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(4,n) = k
        sname_jls(k) = 'E95_Biofuel_source_of_'//trname(n)
        lname_jls(k) = 'CO E95 Biofuel source'
        jls_ltop(k) = 1
        jls_power(k) = -1.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(5,n) = k
        sname_jls(k) = 'E95_Ag_waste_burn_source_of_'//trname(n)
        lname_jls(k) = 'CO E95 Agricultural Waste Burning source'
        jls_ltop(k) = 1
        jls_power(k) = -1.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(6,n) = k
        sname_jls(k) = 'E95_Biomass_burn_source_of_'//trname(n)
        lname_jls(k) = 'CO E95 Biomass burning source'
        jls_ltop(k) = 1
        jls_power(k) = -1.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
#else
      ...
      case ('Isoprene')
        ...
        jls_3Dsource(nStratwrite,n) = k
        sname_jls(k) = 'overwrite_source_of'//trname(n)
        lname_jls(k) = 'CHANGE OF Isoprene BY OVERWRITE'
        jls_ltop(k) = LM
        jls_power(k) = 0.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
...
!! #3 is (common) vegetation source.  See above.
     ...
     &  trname(n)//' EH Agricultural Waste Burning source'
        ...
        jls_source(1,n) = k
        sname_jls(k) = 'E95_Fos_Fuel_Source_of_'//trname(n)
        lname_jls(k) = trname(n)//' E95 fossil fuel source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(2,n) = k
        sname_jls(k) = 'E95_Industrial_Source_of_'//trname(n)
        lname_jls(k) = trname(n)//' E95 Industrial Processes source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(4,n) = k
        sname_jls(k) = 'E95_Waste_hl_source_'//trname(n)
        lname_jls(k) = trname(n)//' E95 Waste Handling source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(5,n) = k
        sname_jls(k) = 'E95_Biofuel_source_of_'//trname(n)
        lname_jls(k) = trname(n)//' E95 Biofuel source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(6,n) = k
        sname_jls(k) = 'E95_Ag_waste_burn_source_of_'//trname(n)
        lname_jls(k) = trname(n)//' E95 Agri. Waste Burning source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
        k = k + 1
        jls_source(7,n) = k
        sname_jls(k) = 'E95_Biomass_burn_source_of_'//trname(n)
        lname_jls(k) = trname(n)//' E95 Biomass burning source'
        jls_ltop(k) = 1
        jls_power(k) = -2.
        units_jls(k) = unit_string(jls_power(k),'kg/s')
#else
...
#endif 
#endif 
      case ('HCl','HOCl','ClONO2','HBr','HOBr','BrONO2')
        k = k + 1
        jls_3Dsource(nChemistry,n) = k
        sname_jls(k) = 'chemistry_source_of'//trname(n)
        lname_jls(k) = 'CHANGE OF '//trname(n)//' BY CHEMISTRY'
...
c heterogenous sink SO2
        ...
        jls_power(k) = -1
        units_jls(k) = unit_string(jls_power(k),'kg/s')
c Laki source of SO2 
c       k = k + 1
c       jls_3Dsource(7,n) = k
c       sname_jls(k) = 'Laki_src_of'//trname(n)
c       lname_jls(k) = 'SO2 Laki source'
c       jls_ltop(k) = LM
c       jls_power(k) = -1
...
! keep AIJ and AJL CO2 sources in same order !!
      ...
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx E95 fossil fuel source'
        sname_ijts(k) = 'NOx_E95_ffuel_source'
        ijts_power(k) = -14
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx E95 industrial processes source'
        sname_ijts(k) = 'NOx_E95_indust_source'
        ijts_power(k) = -14
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx E95 waste handling source'
        sname_ijts(k) = 'NOx_E95_waste_source'
        ijts_power(k) = -14
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc  
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx E95 Biofuel prod, trans, comb source'
        sname_ijts(k) = 'NOx_E95_biofuel_source'
        ijts_power(k) = -14
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx E95 agricultural waste burning source'
        sname_ijts(k) = 'NOx_E95_Ag_waste_source'
        ijts_power(k) = -14
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc  
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx E95 Biomass burning'
        sname_ijts(k) = 'NOx_E95_biomass_source'
        ijts_power(k) = -14
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx Soil source'
        sname_ijts(k) = 'NOx_Soil_source'
        ijts_power(k) = -14
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
#else
      ...
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'NOx Overwrite'
        sname_ijts(k) = 'NOx_overw'
        ijts_power(k) = -12.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
      ...
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CO E95 fossil fuel source'
        sname_ijts(k) = 'CO_E95_ffuel_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CO E95 industrial processes source'
        sname_ijts(k) = 'CO_E95_indust_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CO E95 waste handling source'
        sname_ijts(k) = 'CO_E95_waste_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc  
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CO E95 Biofuel prod, trans, comb source'
        sname_ijts(k) = 'CO_E95_biofuel_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CO E95 agricultural waste burning source'
        sname_ijts(k) = 'CO_E95_Ag_waste_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc  
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CO E95 Biomass burning'
        sname_ijts(k) = 'CO_E95_biomass_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
#else
      ...
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CO Overwrite'
        sname_ijts(k) = 'CO_overw'
        ijts_power(k) = -12.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      ...
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Animal source'
        sname_ijts(k) = 'CH4_E95_Animal_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Fossil Fuel source'
        sname_ijts(k) = 'CH4_E95_ffuel_comb_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Waste source'
        sname_ijts(k) = 'CH4_E95_Waste_handling_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Animal waste management source'
        sname_ijts(k) = 'CH4_E95_Animal_waste'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Agricultural Waste Burning source'
        sname_ijts(k) = 'CH4_E95_Ag_Waste_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Rice cultivation source'
        sname_ijts(k) = 'CH4_E95_Rice_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Biomass Burning source'
        sname_ijts(k) = 'CH4_E95_Biomass_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 E95 Biofuel P,T,C source'
        sname_ijts(k) = 'CH4_E95_Biofuel_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
#else
      ...
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'CH4 Overwrite'
        sname_ijts(k) = 'CH4_overw'
        ijts_power(k) = -12.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
#else
      ...
      k = k + 1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'Isoprene Overwrite'
        sname_ijts(k) = 'Isoprene_overw'
        ijts_power(k) = -12.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
...
!! #3 is the (common) vegetation source. See below.
     ...
     &  trname(n)//' EH agricultural waste burning source'
      ...
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = trname(n)//' E95 fossil fuel source'
        sname_ijts(k) = trname(n)//'_E95_ffuel_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = trname(n)//' E95 industrial processes source'
        sname_ijts(k) = trname(n)//'_E95_indust_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = trname(n)//' E95 waste handling source'
        sname_ijts(k) = trname(n)//'_E95_waste_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc  
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = trname(n)//' E95 Biofuel prod, trans, source'
        sname_ijts(k) = trname(n)//'_E95_biofuel_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = trname(n)//' E95 agri. waste burning source'
        sname_ijts(k) = trname(n)//'_E95_Ag_waste_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc  
      k = k+1
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = trname(n)//' E95 Biomass burning'
        sname_ijts(k) = trname(n)//'_E95_biomass_source'
        ijts_power(k) = -13
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
#else
...
c BCB clear sky longwave radiative forcing
      ...
      case ('OCII')
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = TRIM(trname(n))//' Indust source'
        sname_ijts(k) = TRIM(trname(n))//'_Indust_source'
        ijts_power(k) = -12.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
        k = k + 1
...
c chemical production of SO4 from SO2 on dust
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'SO4_d1 Chemical source'
        sname_ijts(k) = 'SO4_d1_Chemical_source'
        ijts_power(k) = -15.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      case ('SO4_d2')
c chemical production of SO4 from SO2 on dust
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'SO4_d2 Chemical source'
        sname_ijts(k) = 'SO4_d2_Chemical_source'
        ijts_power(k) = -15.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
      case ('SO4_d3')
c chemical production of SO4 from SO2 on dust
        ...
        ijts_index(k) = n
        ia_ijts(k) = ia_src
        lname_ijts(k) = 'SO4_d3 Chemical source'
        sname_ijts(k) = 'SO4_d3_Chemical_source'
        ijts_power(k) = -15.
        units_ijts(k) = unit_string(ijts_power(k),'kg/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
#endif
...
C**** (not necessary associated with a particular tracer)
      ...
      k = k+1
        ...
        units_ijts(k) = unit_string(ijts_power(k),'flash/s*m^2')
        scale_ijts(k) = 10.**(-ijts_power(k))/DTsrc
C NO2 column diagnostic
      k = k+1
        ijs_NO2col=k
        ijts_index(k) = ntm
        ia_ijts(k) = ia_12hr
        lname_ijts(k) = 'NO2 column'
        sname_ijts(k) = 'NO2_col'
        ijts_power(k) = 15.
        units_ijts(k) = unit_string(ijts_power(k),'molecule/cm^2')
C Note factor of 2 to account for ia_12hr
         scale_ijts(k) = 2.0*(10.**(-ijts_power(k)))
...
c         ijts_index(k) = n
c         ia_ijts(k) = ia_rad
c         write(lname_ijts(k),'(a12,i2.2)') 'BCI tau L=  ',L
c         write(sname_ijts(k),'(a12,i2.2)') 'tau_3D_BCI  ',L
c         ijts_power(k) = -2.
...
c         ijts_index(k) = n
c         ia_ijts(k) = ia_rad
c         write(lname_ijts(k),'(a12,i2.2)') 'BCB tau L=  ',L
c         write(sname_ijts(k),'(a12,i2.2)') 'tau_3D_BCB  ',L
c         ijts_power(k) = -2.
c         units_ijts(k) = unit_string(ijts_power(k),' ')
c         scale_ijts(k) = 10.**(-ijts_power(k))
c     end do
...
c         ijts_index(k) = n
c         ia_ijts(k) = ia_rad
c         write(lname_ijts(k),'(a12,i2.2)') 'OC tau L=   ',L
c         write(sname_ijts(k),'(a12,i2.2)') 'tau_3D_OC   ',L
c         ijts_power(k) = -2.
c         units_ijts(k) = unit_string(ijts_power(k),' ')
c         scale_ijts(k) = 10.**(-ijts_power(k))
c     end do
...
c         ijts_index(k) = n
c         ia_ijts(k) = ia_rad
c         write(lname_ijts(k),'(a12,i2.2)') 'SO4 tau L=  ',L
c         write(sname_ijts(k),'(a12,i2.2)') 'tau_3D_SO4  ',L
c         ijts_power(k) = -2.
c         units_ijts(k) = unit_string(ijts_power(k),' ')
c         scale_ijts(k) = 10.**(-ijts_power(k))
c     end do
      ...
      do L=1,LTOP
        k = k + 1
          ...
          ijts_index(k) = n
          ia_ijts(k) = ia_rad
          write(lname_ijts(k),'(a12,i2.2)') 'SS1 tau L=  ',L
          write(sname_ijts(k),'(a12,i2.2)') 'tau_3D_SS1  ',L
          ijts_power(k) = -2.
          units_ijts(k) = unit_string(ijts_power(k),' ')
          scale_ijts(k) = 10.**(-ijts_power(k))
      end do
      ...
      do L=1,LTOP
        k = k + 1
          ...
          ijts_index(k) = n
          ia_ijts(k) = ia_rad
          write(lname_ijts(k),'(a12,i2.2)') 'SS2 tau L=  ',L
          write(sname_ijts(k),'(a12,i2.2)') 'tau_3D_SS2  ',L
          ijts_power(k) = -2.
          units_ijts(k) = unit_string(ijts_power(k),' ')
          scale_ijts(k) = 10.**(-ijts_power(k))
      end do
...
C**** set some defaults
...
#ifdef EDGAR_1995
      g=g+1; itcon_surf(1,N) = g; qcon(itcon_surf(1,N)) = .true.
      conpts(g-12)= 'E95 Animal source'
      g=g+1; itcon_surf(2,N) = g; qcon(itcon_surf(2,N)) = .true.
      conpts(g-12)= 'E95 ffuel comb source'
      g=g+1; itcon_surf(3,N) = g; qcon(itcon_surf(3,N)) = .true.
      conpts(g-12)= 'E95 Waste source'
      g=g+1; itcon_surf(4,N) = g; qcon(itcon_surf(4,N)) = .true.
      conpts(g-12)= 'E95 Animal waste source'
      g=g+1; itcon_surf(5,N) = g; qcon(itcon_surf(5,N)) = .true.
      conpts(g-12)= 'E95 Ag Agric Waste Burn source'
      g=g+1; itcon_surf(8,N) = g; qcon(itcon_surf(8,N)) = .true.
      conpts(g-12)= 'E95 Rice source'
      g=g+1; itcon_surf(12,N) = g; qcon(itcon_surf(12,N)) = .true.
      conpts(g-12)= 'E95 Biomass burn source'
      g=g+1; itcon_surf(13,N) = g; qcon(itcon_surf(13,N)) = .true.
      conpts(g-12)= 'E95 biofuel PTC source'
     ...
     *     sum_unit(n),scale_inst(n),scale_change(n), N,CONPTs)
     ...
     &      'HOBr','BrONO2') ! N2O done above, CFC below
       select case (trname(n)) 
...
#ifdef EDGAR_1995
      g=g+1; itcon_surf(1,N) = g; qcon(itcon_surf(1,N)) = .true.
      conpts(g-12) = 'E95 Fossil Fuel Comb.'
      g=g+1; itcon_surf(2,N) = g; qcon(itcon_surf(2,N)) = .true.
      conpts(g-12) = 'E95 Indust. Proc. Comb.'
      g=g+1; itcon_surf(3,N) = g; qcon(itcon_surf(3,N)) = .true.
      conpts(g-12) = 'E95 Waste Activities'
      g=g+1; itcon_surf(4,N) = g; qcon(itcon_surf(4,N)) = .true.
      conpts(g-12) = 'E95 Biofuel PTC'
      g=g+1; itcon_surf(5,N) = g; qcon(itcon_surf(5,N)) = .true.
      conpts(g-12) = 'E95 Ag Waste Burning'
      g=g+1; itcon_surf(6,N) = g; qcon(itcon_surf(6,N)) = .true.
      conpts(g-12) = 'E95 Biomass Burning'
      g=g+1; itcon_surf(7,N) = g; qcon(itcon_surf(7,N)) = .true.
      conpts(g-12) = 'Soil'
#else
      g=g+1; itcon_surf(1,N) = g
     ...
     *     sum_unit(n),scale_inst(n),scale_change(n), N,CONPTs)
      ...
      conpts(g-12) = 'E95 fossil fuel comb.'
      g=g+1; itcon_surf(2,N) = g; qcon(itcon_surf(2,N)) = .true.
      conpts(g-12) = 'E95 industrial proc.'
      g=g+1; itcon_surf(3,N) = g; qcon(itcon_surf(3,N)) = .true.
      conpts(g-12) = 'E95 waste handling'
      g=g+1; itcon_surf(4,N) = g; qcon(itcon_surf(4,N)) = .true.
      conpts(g-12) = 'E95 biofuel PTC'
      g=g+1; itcon_surf(5,N) = g; qcon(itcon_surf(5,N)) = .true.
      conpts(g-12) = 'E95 agricultural waste'
      g=g+1; itcon_surf(6,N) = g; qcon(itcon_surf(6,N)) = .true.
      conpts(g-12) = 'E95 Biomass burning'
#else
      g=g+1; itcon_surf(1,N) = g
...
!! #3 is (common) vegetation source.  See above.
      ...
      conpts(g-12) = 'E95 Fossil Fuel Comb'
      g=g+1; itcon_surf(2,N) = g; qcon(itcon_surf(2,N)) = .true.
      conpts(g-12) = 'E95 Idustrial Proc'
!! #3 is (common) vegetation source.  See above.
      g=g+1; itcon_surf(4,N) = g; qcon(itcon_surf(4,N)) = .true.
      conpts(g-12) = 'E95 Waste handling'
      g=g+1; itcon_surf(5,N) = g; qcon(itcon_surf(5,N)) = .true.
...
#ifdef EDGAR_1995
      itcon_surf(1,N) = 19
      qcon(itcon_surf(1,N)) = .true.; conpts(7) = 'E95 Fossil fuel'
      itcon_surf(2,N) = 20
      qcon(itcon_surf(2,N)) = .true.; conpts(8) = 'E95 Industrial'
      itcon_surf(3,N) = 21
      qcon(itcon_surf(3,N)) = .true.; conpts(9) = 'E95 Waste hand.'
      itcon_surf(4,N) = 22
      qcon(itcon_surf(4,N)) = .true.; conpts(10) = 'E95 Biofuel'
      itcon_surf(5,N) = 23
      qcon(itcon_surf(5,N)) = .true.; conpts(11) = 'E95 Agr. waste.'
      itcon_surf(6,N) = 24
      qcon(itcon_surf(6,N)) = .true.; conpts(12) = 'E95 Biomass Burn'
      itcon_mc(n) =25
      qcon(itcon_mc(n)) = .true.  ; conpts(13) = 'MOIST CONV'
      itcon_ss(n) =26
      qcon(itcon_ss(n)) = .true.  ; conpts(14) = 'LS COND'
#ifdef TRACERS_DRYDEP
      if(dodrydep(n)) then
        itcon_dd(n,1)=27
        qcon(itcon_dd(n,1)) = .true. ; conpts(15) = 'TURB DEP'
        qsum(itcon_dd(n,1)) = .false.
      end if
#endif
#else
...
#ifdef EDGAR_1995
      itcon_surf(1,N) = 17
      qcon(itcon_surf(1,N)) = .true.; conpts(5) = 'E95 Fossil fuel'
      itcon_surf(2,N) = 18
      qcon(itcon_surf(2,N)) = .true.; conpts(6) = 'E95 Industrial'
      itcon_surf(3,N) = 19
      qcon(itcon_surf(3,N)) = .true.; conpts(7) = 'E95 Waste hand.'
      itcon_surf(4,N) = 20
      qcon(itcon_surf(4,N)) = .true.; conpts(8) = 'E95 Biofuel'
      itcon_surf(5,N) = 21
      qcon(itcon_surf(5,N)) = .true.; conpts(9) = 'E95 Agr. waste.'
      itcon_surf(6,N) = 22
      qcon(itcon_surf(6,N)) = .true.; conpts(10) = 'E95 Biomass Burn'
      itcon_mc(n) =23
      qcon(itcon_mc(n)) = .true.  ; conpts(11) = 'MOIST CONV'
      itcon_ss(n) =24
      qcon(itcon_ss(n)) = .true.  ; conpts(12) = 'LS COND'
#ifdef TRACERS_DRYDEP
      if(dodrydep(n)) then
        itcon_dd(n,1)=25
        qcon(itcon_dd(n,1)) = .true. ; conpts(13) = 'TURB DEP'
        qsum(itcon_dd(n,1)) = .false.
        itcon_dd(n,2)=26
        qcon(itcon_dd(n,2)) = .true. ; conpts(14) = 'GRAV SET'
        qsum(itcon_dd(n,2)) = .false.
      end if
#endif
#else
...
c          write(6,*) 'In TRACER_IC:',trname(n),' does not exist '
        ...
        case ('CH4')
          ...
          first_mod(:,:,:)=.true. 
          first_ncep(:)=.true. 
          if(.not.first_mod(23,23,3)) stop'gsf1'
#endif
#endif
#ifdef TRACERS_SPECIAL_Lerner
...
C         AM=kg/m2, and DXYP=m2:
     ...
     *         'seasalt1', 'seasalt2','OCI1','OCI2','OCI3','OCA1',
     *         'OCA2','OCA3','OCA4')
          do l=1,lm; do j=J_0,J_1; do i=1,im
            trm(i,j,l,n) = am(l,i,j)*dxyp(j)*TR_MM(n)*bymair*5.d-14
          end do; end do; end do
...
C****
      if (rnsrc.eq.2) then
#ifdef TRACERS_COSMO
c read in radon emission for Schery and Wasiolek source
      rn_src(:,:,:)=0.d0
      call openunit('Radon',mon_unit,.false.)
      do mm=1,12
      read(mon_unit,*) i
      do mmm=1,3312
      read(mon_unit,*) ii,jj,carbstuff
      rn_src(ii,jj,mm)=carbstuff/1000.d0*dxyp(jj)*0.222d0/2.1d-6/6.02d23
     *  *0.5d0
c convert from mBq/m2/s to kg/s
c 0.5 is an arbitrary reduction factor
      end do
      end do
...
C**** Note this routine must always exist (but can be a dummy routine)
      USE MODEL_COM, only: jmon,itime,coupled_chem,jyear
      USE DOMAIN_DECOMP, only : grid, get
...
C         (lightning called from tracer_3Dsource)
     ...
     &    call get_sulfate_N2O5 !not applied directly;used in chemistry.
      ...
      do n=1,ntm
        ...
        case ('BCB')  ! this does BCB and OCB
...
!@auth Jean Lerner/Gavin Schmidt
     ...
     *  ,dtsrc,jmon,nday
      ...
      USE TRACER_COM
      USE FLUXES, only: trsource,tr3Dsource
...
C         Make sure index KY=1 in year that tracer turns on
          ...
          anngas = x*airm
        else if (trname(n).eq.'SF6_c') then
          ky = 1
          base = (0.3d-12)*tr_mm(n)/mair !pptm
          x = base*ky
          airm = (psf-pmtop)*100.*bygrav*AREAG !(kg/m**2 X m**2 = kg)
...
#ifdef EDGAR_1995 
C Emit some of sulfur as SO4 and change units from kgSO2/m2/s to kgSO2/s
        do ns=1,ntsurfsrc(n)
         do j=J_0,J_1
...
c  Laki
      if (JYEAR.eq.1783) then
       ...
       do l=1,5
        SO2_src_3d(33,40,l,4)=LAKI_AMT_T(j)/sday*1.D9/5.d0
       end do
       ltpp=LTROPO(33,40)
       do l=ltpp+1,ltpp+3
        SO2_src_3d(33,40,l,4)=LAKI_AMT_S(j)/sday*1.D9/3.d0
       end do
       endif
       enddo
      endif
c End Laki code
      ...
      tr3Dsource(:,J_0:J_1,:,4,n) = SO2_src_3d(:,J_0:J_1,:,4)
      call apply_tracer_3Dsource(4,n) ! Laki volcano
...
c
      ...
      tr3Dsource(:,J_0:J_1,:,nLightning,n_NOx) = 0.d0
