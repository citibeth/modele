...
c
      k=k+1 !
      IJ_CONDMC = k ! COND MC (mm/day)       1 CN
      lname_ij(k) = 'CONVECTIVE CONDENSATION (GROSS)'
      units_ij(k) = 'mm/day'
      name_ij(k) = 'cond_mc'
      ia_ij(k) = ia_src
      scale_ij(k) = SDAY/DTsrc
...
c
      k=k+1 !
      IJ_DETRMC = k ! DETR MC (mm/day)       1 CN
      lname_ij(k) = 'CONVECTIVE CONDENSATION DETRAINED AS CLW'
      units_ij(k) = 'mm/day'
      name_ij(k) = 'detr_mc'
      ia_ij(k) = ia_src
      scale_ij(k) = SDAY/DTsrc
      ...
      k=k+1 !
      IJ_DEVAPMC = k ! DDRAFT MC (mm/day)       1 CN
      lname_ij(k) = 'CONVECTIVE EVAP IN DDRAFT'
      units_ij(k) = 'mm/day'
      name_ij(k) = 'ddrftevap_mc'
      ia_ij(k) = ia_src
      scale_ij(k) = SDAY/DTsrc
      ir_ij(k) = ir_0_3_15

      k=k+1 !
      IJ_PEVPMC = k ! PCP EVAP MC (mm/day)       1 CN
      lname_ij(k) = 'CONVECTIVE EVAP FROM PREC'
      units_ij(k) = 'mm/day'
      name_ij(k) = 'pcpevap_mc'
      ia_ij(k) = ia_src
      scale_ij(k) = SDAY/DTsrc
      ir_ij(k) = ir_0_3_15

      k=k+1 !
      IJ_CONDLS = k ! COND LS (mm/day)       1 CN
      lname_ij(k) = 'LS CONDENSATION'
      units_ij(k) = 'mm/day'
      name_ij(k) = 'cond_ls'
      ia_ij(k) = ia_src
      scale_ij(k) = SDAY/DTsrc
      ...
      k=k+1 !
      IJ_EVAPLS = k !  EVAP LS (mm/day)       1 CN
      lname_ij(k) = 'LS EVAP '
      units_ij(k) = 'mm/day'
      name_ij(k) = 'evap_ls'
      ia_ij(k) = ia_src
      ...
      k=k+1 !
      IJ_CONDSINKMC = k !  S        1 CN
      lname_ij(k) = 'SUM of MC condensation sink terms '
      units_ij(k) = 'mm/day'
      name_ij(k) = 'condsink_mc'
      ia_ij(k) = ia_src
      scale_ij(k) = SDAY/DTsrc
      ir_ij(k) = ir_0_3_15

      k=k+1 !
      IJ_CONDCOUNTMC = k !  Counter for non-zero MC condensation
 
      k=k+1 !
      IJ_DETRFRACMC = k !  S        1 CN
      lname_ij(k) = 'Ratio of clw detr. to condensation'
      units_ij(k) = ''
      name_ij(k) = 'detrfrac_mc'
      ia_ij(k) = ia_src
      denom_ij(k) = IJ_CONDCOUNTMC
      ir_ij(k) = ir_0_3_15

      k=k+1 !
      IJ_RECYCMC = k !  S        1 CN
      lname_ij(k) = 'Ratio of mc evap to condensation'
      units_ij(k) = ''
      name_ij(k) = 'recyc_mc'
      ia_ij(k) = ia_src
      denom_ij(k) = IJ_CONDCOUNTMC
      ...
      k=k+1 !
      IJ_RECYCNODETRMC = k !  S        1 CN
      lname_ij(k) = 'Ratio of mc evap to (condensation-detr)'
      units_ij(k) = ''
      name_ij(k) = 'recycnodetr_mc'
      ia_ij(k) = ia_src
      denom_ij(k) = IJ_CONDCOUNTMC
      ir_ij(k) = ir_0_3_15

      k=k+1 !
      IJ_PRECEFFMC = k !  S        1 CN
      lname_ij(k) = 'Ratio of mc precip to condensation'
      units_ij(k) = ''
      name_ij(k) = 'preceff_mc'
      ia_ij(k) = ia_src
      denom_ij(k) = IJ_CONDCOUNTMC
      ir_ij(k) = ir_0_3_15

      k=k+1 !
      IJ_PRECEFFNODETRMC = k !  S        1 CN
      lname_ij(k) = 'Ratio of mc precip to (condensation-detr)'
      units_ij(k) = ''
      name_ij(k) = 'preceffnodetr_mc'
      ia_ij(k) = ia_src
      denom_ij(k) = IJ_CONDCOUNTMC
      ir_ij(k) = ir_0_3_15
...
c
      ...
      dim3name(k) = 'pgz'
      dim3units(k) = 'mb'
      coord3(1:7,k) = (/1000.,850.,700.,500.,300.,100.,30./)
c
      k=k+1 !
...
c
      ...
      dim3name(k) = 'pcp'
      dim3units(k) = 'mb'
      coord3(1:5,k) = (/100.,300.,500.,700.,850./)
      ij_cp_diminfo = k
c
      k=k+1 !
      IJ_T300 = k !
...
c
      k=k+1
      IJ_3dNWSS = k
      lname_ij(k) = '2D Warm LS screened CDNC '
      units_ij(k) = 'cm^-3'
      name_ij(k) = 'NwsS3d'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      ...
      k=k+1 !
      IJ_SWCRF_FIX_MET = k ! SW cloud radiative forcing (W/m**2) without aerosols and Ozone
      lname_ij(k) = 'SW CLOUD RF AT FIXED METEOROLOGY'
      units_ij(k) = 'W/m^2'
...
c
      k=k+1 !
      IJ_LWCRF_FIX_MET = k ! LW cloud radiative forcing (W/m**2) without aerosols and Ozone
      lname_ij(k) = 'LW CLOUD RF AT FIXED METEOROLOGY'
      units_ij(k) = 'W/m^2'
      ...
      if (aer_rad_forc.gt.0) then ! only define aij arrays if forcing is calculated
         ...
         DO N=1,8
            ...
            index1(k) = IJ_SWAERRF
            if(n.eq.1) then
               name3(k) = 'swaerrf_toa_byType'
               lname3(k) = 'SW AER RADIATIVE FORCING, TOA'
               dim3name(k) = 'aerType'
               ij_aer_diminfo = k
            endif
         END DO
c
         ...
         DO N=1,8
            ...
            index1(k) = IJ_LWAERRF
            if(n.eq.1) then
               name3(k) = 'lwaerrf_toa_byType'
               lname3(k) = 'LW AER RADIATIVE FORCING, TOA'
               dim3info_index(k) = ij_aer_diminfo
            endif
         END DO
         
         IJ_SWAERTRF = k+1      ! Tropopause SW aerosol rad forcing (W/m**2)
         DO N=1,8
            k=k+1
            lname_ij(k) = 
     *           'SW AER RADIATIVE FORCING, Tpause N='//char(N+48)
            units_ij(k) = 'W/m^2'
            name_ij(k) = 'swaerrf_tps_'//char(n+48)
            ia_ij(k) = ia_rad_frc
            scale_ij(k) = 1.
            ir_ij(k) = ir_m95_265
            index1(k) = IJ_SWAERTRF
            if(n.eq.1) then
               name3(k) = 'swaerrf_tps_byType'
               lname3(k) = 'SW AER RADIATIVE FORCING, Tropopause'
               dim3info_index(k) = ij_aer_diminfo
            endif
         END DO
         
         IJ_LWAERTRF = k+1      ! Tropopause LW aerosol rad forcing (W/m**2)
         DO N=1,8
            k=k+1
            lname_ij(k) = 
     *           'LW AER RADIATIVE FORCING, Tpause N='//char(N+48)
            units_ij(k) = 'W/m^2'
            name_ij(k) = 'lwaerrf_tps_'//char(n+48)
            ia_ij(k) = ia_rad_frc
            scale_ij(k) = 1.
            ir_ij(k) = ir_m95_265
            index1(k) = IJ_LWAERTRF
            if(n.eq.1) then
               name3(k) = 'lwaerrf_tps_byType'
               lname3(k) = 'LW AER RADIATIVE FORCING, Tropopause'
               dim3info_index(k) = ij_aer_diminfo
            endif
         END DO
         ...
         DO N=1,8
            k=k+1
            lname_ij(k) = 
     *           'SW AER RADIATIVE FORCING, SURF N='//char(N+48)
            units_ij(k) = 'W/m^2'
            name_ij(k) = 'swaerrf_surf_'//char(n+48)
            ia_ij(k) = ia_rad_frc
            scale_ij(k) = 1.
            ir_ij(k) = ir_m95_265
            index1(k) = IJ_SWAERSRF
            if(n.eq.1) then
               name3(k) = 'swaerrf_surf_byType'
               lname3(k) = 'SW AER RADIATIVE FORCING, SURF'
               dim3info_index(k) = ij_aer_diminfo
            endif
         END DO
c     
         ...
         DO N=1,8
            k=k+1
            lname_ij(k) = 
     *           'LW AER RADIATIVE FORCING, SURF N='//char(N+48)
            units_ij(k) = 'W/m^2'
            name_ij(k) = 'lwaerrf_surf_'//char(n+48)
            ia_ij(k) = ia_rad_frc
            scale_ij(k) = 1.
            ir_ij(k) = ir_m95_265
            index1(k) = IJ_LWAERSRF
            if(n.eq.1) then
               name3(k) = 'lwaerrf_surf_byType'
               lname3(k) = 'LW AER RADIATIVE FORCING, SURF'
               dim3info_index(k) = ij_aer_diminfo
            endif
         END DO
c     
         ...
         DO N=1,8
            ...
            scale_ij(k) = 1.
            ir_ij(k) = ir_m95_265
            index1(k) = IJ_SWAERABS
            if(n.eq.1) then
               name3(k) = 'swaeraa_toa_byType'
               lname3(k) = 'SW AER ATMOS. ABSORPTION'
               dim3info_index(k) = ij_aer_diminfo
            endif
         END DO
c     
         ...
         DO N=1,8
            ...
            scale_ij(k) = 1.
            ir_ij(k) = ir_m95_265
            index1(k) = IJ_LWAERABS
            if(n.eq.1) then
               name3(k) = 'lwaeraa_toa_byType'
               lname3(k) = 'LW AER ATMOS. ABSORPTION'
               dim3info_index(k) = ij_aer_diminfo
            endif
         END DO
c     
...
c     
         k=k+1
         IJ_SWAERTRFNT = k      ! NET Tpause SW aerosol rad forcing (W/m**2)
         lname_ij(k) = 'SW AER RADIATIVE FORCING, Tpause NET'
         units_ij(k) = 'W/m^2'
         name_ij(k) = 'swaerrf_tps_net'
         ia_ij(k) = ia_rad_frc
         scale_ij(k) = 1.
         ir_ij(k) = ir_m95_265
         
         k=k+1
         IJ_LWAERTRFNT = k      ! NET Tpause LW aerosol rad forcing (W/m**2)
         lname_ij(k) = 'LW AER RADIATIVE FORCING, Tpause NET'
         units_ij(k) = 'W/m^2'
         name_ij(k) = 'lwaerrf_tps_net'
         ia_ij(k) = ia_rad_frc
         scale_ij(k) = 1.
         ir_ij(k) = ir_m95_265
...
c     
      ...
      endif                     ! end case for aer_rad_forc
c     
      k=k+1                     !
...
c
      ...
      index1(k) = IJ_GBSW
      name3(k) = 'bs_wlay'
      lname3(k) = 'BARE SOIL WATER'
      dim3name(k) = 'gdepth'
      dim3units(k) = 'm'
      coord3(1:6,k) = (/0.05,0.18627,0.42140,0.82710,1.52712,2.73495/)
      ij_ghy_diminfo = k
c
      k=k+1
      name_ij(k) = 'bs_wlay2' !
...
c
      ...
      index1(k) = IJ_GVSW+1
      name3(k) = 'vs_wlay'
      lname3(k) = 'VEGETATED SOIL WATER'
      dim3info_index(k) = ij_ghy_diminfo
c
      k=k+1
      name_ij(k) = 'vs_wlay2' !
...
c
      ...
      index1(k) = IJ_GBST
      name3(k) = 'bs_tlay'
      lname3(k) = 'BARE SOIL TEMPERATURE'
      dim3info_index(k) = ij_ghy_diminfo
c
      k=k+1
      name_ij(k) = 'bs_tlay2' !
...
c
      ...
      index1(k) = IJ_GVST+1
      name3(k) = 'vs_tlay'
      lname3(k) = 'VEGETATED SOIL TEMPERATURE'
      dim3info_index(k) = ij_ghy_diminfo
c
      k=k+1
      name_ij(k) = 'vs_tlay2' !
...
c
      ...
      k=k+1 !
      IJ_OPTDW_FIX_MET = k
      lname_ij(k) = 'WATER CLOUD OPTICAL DEPTH FIX MET'
      units_ij(k) = ''
      name_ij(k) = 'optdw_fix'
      ia_ij(k) = ia_rad
      scale_ij(k) = 1.
...
c
      k=k+1 !
      IJ_OPTDI_FIX_MET = k
      lname_ij(k) = 'ICE CLOUD OPTICAL DEPTH FIX MET'
      units_ij(k) = ''
      name_ij(k) = 'optdi_fix'
      ia_ij(k) = ia_rad
      scale_ij(k) = 1.
...
c      scale_ij(k) = 1.
      ...
      ir_ij(k) = ir_pct
#endif
C**** RDF definition of 2D diagnostics 
#ifdef TES_SIM
      k=k+1 !
      IJ_TES_SUNL = k ! counter only
      ia_ij(k) = ia_dga
	  
      k=k+1 !
      IJ_TES_TTL = k
      lname_ij(k) = 'Total subgrid count'
      units_ij(k) = '#'
      name_ij(k) = 'ISCCP_subgrid_ttl'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_SUNL
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_GOOD = k
      lname_ij(k) = 'Good subgrid count'
      units_ij(k) = '#'
      name_ij(k) = 'ISCCP_subgrid_good'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_SUNL
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_TTL_CLDY = k
      lname_ij(k) = 'Cloudy subgrid count'
      units_ij(k) = '#'
      name_ij(k) = 'TES_CLDY_COUNT'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_SUNL
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_TTL_CLDY_GOOD = k
      lname_ij(k) = 'Cloudy subgrid count over high quality retrievals'
      units_ij(k) = '#'
      name_ij(k) = 'TES_CLDY_COUNT_GOOD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_SUNL
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_TTL_R = k
      lname_ij(k) = '# of TES obs for retrieval AK selection'
      units_ij(k) = '#'
      name_ij(k) = 'TES_retr_ttl '
      ia_ij(k) = ia_dga
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_GOOD_R = k
      lname_ij(k) = ' # of good TES obs for retrieval AK selection'
      units_ij(k) = '#'
      name_ij(k) = 'TES_retr_good '
      ia_ij(k) = ia_dga
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_CLDY_GOOD_R = k
      lname_ij(k) = ' # of good cloudy TES obs for retr AK selection'
      units_ij(k) = '#'
      name_ij(k) = 'TES_retr_cldy_good '
      ia_ij(k) = ia_dga
      scale_ij(k) = 1.


C**** Categorical variables over all subgrid sunlit? points
      k=k+1 !
      IJ_TES_TGRND = k
      lname_ij(k) = 'Ground temperature'
      units_ij(k) = 'K'
      name_ij(k) = 'TES_TGRND'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_PWL = k
      lname_ij(k) = 'Pcp water near surface'
      units_ij(k) = 'mm'
      name_ij(k) = 'TES_PWLOW'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL
      ...
      k=k+1 !
      IJ_TES_PWH = k
      lname_ij(k) = 'Pcp water in free atm'
      units_ij(k) = 'mm'
      name_ij(k) = 'TES_PWHIGH'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_COD = k
      lname_ij(k) = 'Cloud optical depth'
      units_ij(k) = ''
      name_ij(k) = 'TES_COD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL
      ...
      name_ij(k) = 'TES_CTP'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL_CLDY
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_CODCLDY = k
      lname_ij(k) = 'Cloud optical depth for COD > codMax only'
      units_ij(k) = ''
      name_ij(k) = 'TES_CODCLDY'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL_CLDY
      scale_ij(k) = 1.

C**** Categorical variables over all cat. high quality  points
      k=k+1 !
      IJ_TES_TGRND_GOOD = k
      lname_ij(k) = 'GrTemp for cat. high qual'
      units_ij(k) = 'K'
      name_ij(k) = 'TES_TGRND_GOOD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_PWL_GOOD = k
      lname_ij(k) = 'Pcp water near surface for cat. high qual'
      units_ij(k) = 'mm'
      name_ij(k) = 'TES_PWLOW_GOOD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_PWH_GOOD = k
      lname_ij(k) = 'Pcp water in free atm for cat. high qual'
      units_ij(k) = 'mm'
      name_ij(k) = 'TES_PWHIGH_GOOD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_COD_GOOD = k
      lname_ij(k) = 'Cloud optical depth for cat. high qual'
      units_ij(k) = ''
      name_ij(k) = 'TES_COD_GOOD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_CTP_GOOD = k
      lname_ij(k) = 'Cloud top pressure for cat. high qual'
      units_ij(k) = 'hPa'
      name_ij(k) = 'TES_CTP_GOOD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL_CLDY_GOOD
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_CODCLDY_GOOD = k
      lname_ij(k) = 'COD for COD > codMax for cat. high qual'
      units_ij(k) = ''
      name_ij(k) = 'TES_CODCLDY_GOOD'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_TTL_CLDY_GOOD
      scale_ij(k) = 1.

C**** Categorical variables over all retrieval. high quality  points
      k=k+1 !
      IJ_TES_TGRND_GOOD_R = k
      lname_ij(k) = 'GrTemp for retr. high qual'
      units_ij(k) = 'K'
      name_ij(k) = 'TES_TGRND_GOOD_R'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD_R
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_PWL_GOOD_R = k
      lname_ij(k) = 'Pcp water near surface for retr. high qual'
      units_ij(k) = 'mm'
      name_ij(k) = 'TES_PWLOW_GOOD_R'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD_R
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_PWH_GOOD_R = k
      lname_ij(k) = 'Pcp water in free atm for retr. high qual'
      units_ij(k) = 'mm'
      name_ij(k) = 'TES_PWHIGH_GOOD_R'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD_R
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_COD_GOOD_R = k
      lname_ij(k) = 'Cloud optical depth for retr. high qual'
      units_ij(k) = ''
      name_ij(k) = 'TES_COD_GOOD_R'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_GOOD_R
      scale_ij(k) = 1.
      ...
      k=k+1 !
      IJ_TES_CTP_GOOD_R = k
      lname_ij(k) = 'Cloud top pressure for retr. high qual'
      units_ij(k) = 'hPa'
      name_ij(k) = 'TES_CTP_GOOD_R'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_CLDY_GOOD_R
      scale_ij(k) = 1.

      k=k+1 !
      IJ_TES_CODCLDY_GOOD_R = k
      lname_ij(k) = 'COD for COD > codMax for retr. high qual'
      units_ij(k) = ''
      name_ij(k) = 'TES_CODCLDY_GOOD_R'
      ia_ij(k) = ia_dga
      denom_ij(k) = IJ_TES_CLDY_GOOD_R
      scale_ij(k) = 1.
...
c
     ...
     &     ,bymrat
      ...
      USE MODEL_COM, only : pmidl00,lm_req
      use DIAG_COM
      USE DOMAIN_DECOMP_ATM, only: AM_I_ROOT
#ifdef NEW_IO
      use cdl_mod
...
#ifdef TES_SIM
C
C     For categorical avg krnl selection
C
C     QF only H2O and HDO tracers
      k=k+1
      IJL_DP_QF = k  ! not output - this field serves only as a weight
      ia_ijl(k) = ia_dga

      k=k+1        ! QF only H2O mixing ratio from taijl
      IJL_H2O_QF   = k
      name_ijl(k)  = 'H2O_QF_CAT'
      lname_ijl(k) = 'QualFilt H2O mixing ratio, categorical avg krnls'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_QF
      ia_ijl(k)    = ia_dga
      lgrid_ijl(k) = ctr_ml

      k=k+1        ! QF HDO mixing ratio from taijl
      IJL_HDO_QF   = k
      name_ijl(k)  = 'HDO_QF_CAT'
      lname_ijl(k) = 'QualFilt HDO mixing ratio, categorical avg krnls'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_QF
      ia_ijl(k)    = ia_dga
...
c   TES STYLE
      k=k+1
      IJL_DP_TES = k  ! not output - this field serves only as a (selective) weight
      ia_ijl(k) = ia_dga
	  
      k=k+1        ! 
      IJL_H2O_TES   = k
      name_ijl(k)  = 'H2O_TES_CAT'
      lname_ijl(k) = 'TES H2O, categorical avg krnls'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES
      ia_ijl(k)    = ia_dga
      lgrid_ijl(k) = ctr_ml

      k=k+1        ! 
      IJL_HDO_TES   = k
      name_ijl(k)  = 'HDO_TES_CAT'
      lname_ijl(k) = 'TES HDO, categorical avg krnls'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_H2O_TES_OLD   = k
      name_ijl(k)  = 'H2O_TES_OLD_CAT'
      lname_ijl(k) = 'TES H2O, interp only, categorical avg krnls'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_HDO_TES_OLD   = k
      name_ijl(k)  = 'HDO_TES_OLD_CAT'
      lname_ijl(k) = 'TES HDO, interp only, categorical avg krnls'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_H2O_PRIOR   = k
      name_ijl(k)  = 'H2O_PRIOR_CAT'
      lname_ijl(k) = 'H2O Prior, categorical avg krnls'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_TES_SEN   = k
      name_ijl(k)  = 'Max_sens_cat'
      lname_ijl(k) = 'Max sensitivity from cat AK'
      units_ijl(k) = ''
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_TES_SEN_HT   = k
      name_ijl(k)  = 'Max_sens_cat_ht'
      lname_ijl(k) = 'Height of max sensitivity from cat AK'
      units_ijl(k) = 'hPa'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES
      ia_ijl(k)    = ia_dga
...
C
C     For avg krnl selection from individual retrievals.
C

C     QF H2O and HDO tracers for comparison to taijl 
      k=k+1
      IJL_DP_QF_R = k  ! not output - this field serves only as a weight
      ia_ijl(k) = ia_dga

      k=k+1        ! QF H2O mixing ratio from taijl
      IJL_H2O_QF_R   = k
      name_ijl(k)  = 'H2O_QF_RETR'
      lname_ijl(k) = 'QualFilt H2O, avg krnls from retrievals'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_QF_R
      ia_ijl(k)    = ia_dga
      lgrid_ijl(k) = ctr_ml

      k=k+1        ! QF HDO mixing ratio from taijl
      IJL_HDO_QF_R   = k
      name_ijl(k)  = 'HDO_QF_RETR'
      lname_ijl(k) = 'QualFilt HDO, avg krnls from retrievals'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_QF_R
      ia_ijl(k)    = ia_dga
...
c   TES STYLE 
      k=k+1
      IJL_DP_TES_R = k  ! not output - this field serves only as a (selective) weight
      ia_ijl(k) = ia_dga
	  
      k=k+1        ! 
      IJL_H2O_TES_R   = k
      name_ijl(k)  = 'H2O_TES_RETR'
      lname_ijl(k) = 'TES H2O, avg krnls from retrievals'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES_R
      ia_ijl(k)    = ia_dga
      lgrid_ijl(k) = ctr_ml

      k=k+1        ! 
      IJL_HDO_TES_R   = k
      name_ijl(k)  = 'HDO_TES_RETR'
      lname_ijl(k) = 'TES HDO, avg krnls from retrievals'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES_R
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_H2O_TES_OLD_R   = k
      name_ijl(k)  = 'H2O_TES_OLD_RETR'
      lname_ijl(k) = 'TES H2O, interp only, avg krnls from retrievals'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES_R
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_HDO_TES_OLD_R   = k
      name_ijl(k)  = 'HDO_TES_OLD_RETR'
      lname_ijl(k) = 'TES HDO, interp only, avg krnls from retrievals'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES_R
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_H2O_PRIOR_R   = k
      name_ijl(k)  = 'H2O_PRIOR_RETR'
      lname_ijl(k) = 'H2O Prior, avg krnls from retrievals'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES_R
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_TES_SEN_R   = k
      name_ijl(k)  = 'Max_sens_retr'
      lname_ijl(k) = 'Max sensitivity from retr AK'
      units_ijl(k) = ''
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES_R
      ia_ijl(k)    = ia_dga
      ...
      k=k+1        ! 
      IJL_TES_SEN_HT_R   = k
      name_ijl(k)  = 'Max_sens_ht_retr'
      lname_ijl(k) = 'Height of max sensitivity from retr'
      units_ijl(k) = 'hPa'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP_TES_R
      ia_ijl(k)    = ia_dga
...
c Column Diagnostics
       ...
       idd_lwc_ls=k+1
        do l=1,LM
          k=k+1
          name_dd(k)='LWC_ls_L'//lst(l)
          units_dd(k)='kg/m3'
          scale_dd(k)=1.
          lname_dd(k)=' LWC_ls_L'//lst(l)
        end do

       idd_lwc_cc=k+1
        do l=1,LM
          k=k+1
          name_dd(k)='LWC_cc_L'//lst(l)
          units_dd(k)='kg/m3'
          scale_dd(k)=1.
          lname_dd(k)=' LWC_cc_L'//lst(l)
        end do
