...
C**** Convert spaces in TITLE to underscore
     ...
     *       (cnslat(J,K),K=1,KMAX)
      ...
      WRITE(iu_jc,*)
C**** output hemispheric and global means
      WRITE(iu_jc,'(A6,50(1X,1pE11.4))')"NH",(cnslat(JM+2,K),K=1,KMAX)
      WRITE(iu_jc,'(A6,50(1X,1pE11.4))')"SH",(cnslat(JM+1,K),K=1,KMAX)
      WRITE(iu_jc,'(A6,50(1X,1pE11.4))')"GLOB",(cnslat(JM+3,K),K=1,KMAX)
      WRITE(iu_jc,*)
