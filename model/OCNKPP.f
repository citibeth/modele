...
!@+       from input dataset
      integer :: use_tdiss=0
!@var tdiss prescribed column-integrated tidal dissipation (W/m2)
...
C****
     ...
     *     ,ij_hbl,ij_bo,ij_bosol,ij_ustar,ijl_kvm,ijl_kvg,ijl_kvx
...
C****
     ...
     &     (1.325d-4-.75d-5)*(atan((ze(l)-2000d0)/200d0)/pi + 0.5d0)
        ! subtract default background value
...
C****
C**** Adjust subgrid vertical gradients
C****
