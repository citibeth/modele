...
E001TM53: 53 layer 4x5 model sample tracers
 Air mass (not activated), SF6, RN222, CO2, 14CO2, CFC-11, CH4, N2O, linearizedO3, SF6_c 
...
N2O_IC=N2O_Shindell_Jan9293_M53x            !initial conditions
...
nstrtc=28   ! Number of layers for Prather stratosphere chemistry (resolution dependent)
&&END_PARAMETERS

 &INPUTZ
   YEARI=1950,MONTHI=10,DATEI=1,HOURI=0,  !  from default: IYEAR1=YEARI
   YEARE=1956,MONTHE=1,DATEE=1,HOURE=0,    KDIAG=13*0,
   YEARE=1950,MONTHE=2,
   ISTART=2,IRANDI=0, YEARE=1950,MONTHE=10,DATEE=1,HOURE=1,IWRITE=1,JWRITE=1,
 &END

NOTE: Lerner CFC-11 turns on April 1; 14CO2 turns on mid-October
