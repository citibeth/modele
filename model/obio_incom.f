...
!note that in hycom we define it shallower because phyto and ndet profiles have maxima 
!higher in the column than gary's ocean model
#ifdef OBIO_ON_GARYocean
      real, parameter ::  zc = 75. ! in meters (from OCMIP)
#else
      real, parameter ::  zc = 50. ! in meters (from OCMIP)
#endif
