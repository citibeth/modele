...
#ifdef NEW_IO_O3INP
! In this case, netcdf-based I/O is invoked.
! O3inp.f gives different results than the Fortran-I/O version, since
...
! and native GCM horizonal resolution (IM x JM) and no trend file.
      ...
      integer, parameter ::
     & NFO3x=17,     !  max. number of decadal ozone files used
     & IYIO3=1850,   !  year of earliest ozone file (not trend file) 
     & IYEO3=2010    !  year of last ozone file (not trend file)
...
!@+ add_sol*delta_O3_max_min
      ...
      integer, dimension(NFO3X) :: IYEAR = (/1850,1860,1870,1880,1890,
