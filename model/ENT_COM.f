...
#ifdef CUBED_SPHERE /* setting separately so as not to disrupt */
      integer, parameter :: ENT_IO_MAXBUF = 1122
#else /* but this size should really be determined at runtime */
      integer, parameter :: ENT_IO_MAXBUF = 1023 !1023 after NK !924 ! 575
#endif

!@var skip_ent_state skip reading Ent state from the restart file
!@+   (used when restarting from an incompatible restart file)
      logical :: skip_ent_state = .false.
