...
!          betad = cop%stressH2O
...
#ifndef WATERSTRESS4
          !!write(999,*) 'Calling water_stress3' 
     ...
     &          cop%fracroot, pp%cellptr%fice(:), cop%stressH2Ol(:))
#else
          !!write(999,*) 'Calling water_stress4' !## NK HACK  DEBUG DELETE ##!
          !NYK - water_stress4 biases root water uptake to least stressed layer                instead of weighting by root mass.
