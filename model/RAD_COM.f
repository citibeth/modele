...
!@var AX_rad_save 3D aerosol extinction saved from radiation
      REAL*8, ALLOCATABLE, DIMENSION(:,:,:) :: AX_rad_save !saved in rsf
...
!@var nrad_clay index of clay in arrays for optional aerosol interaction
      INTEGER :: nrad_clay
!@var cosz2 weighting function for the solar input
...
!@ver  1.0
     ...
     *     SRDN, CFRAC, RCLD, O3_rad_save, O3_tracer_save, AX_rad_save,
     *     KLIQ, COSZ1, dH2O, ALB, SALB, SINJ, COSJ,srnflb_save,
     &     trnflb_save,ttausv_save,ttausv_cs_save,cosz2
...
!@var HEADER_F Character string label for records (forcing runs)
  ...
  ! rest needed only if MODRAD>0 at restart
     ...
     *    ,O3_rad_save,O3_tracer_save,AX_rad_save
#ifdef TRACERS_DUST
