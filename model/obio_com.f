...
c
      ...
      real, ALLOCATABLE, DIMENSION(:,:)    :: pp2diat_day_glob
      real, ALLOCATABLE, DIMENSION(:,:)    :: pp2chlo_day
      real, ALLOCATABLE, DIMENSION(:,:)    :: pp2chlo_day_glob
      real, ALLOCATABLE, DIMENSION(:,:)    :: pp2cyan_day
      real, ALLOCATABLE, DIMENSION(:,:)    :: pp2cyan_day_glob
      real, ALLOCATABLE, DIMENSION(:,:)    :: pp2cocc_day
      real, ALLOCATABLE, DIMENSION(:,:)    :: pp2cocc_day_glob
...
!     integer, parameter :: itest=96, jtest=120    !N. Atlantic
!     integer, parameter :: itest=150, jtest=160    !ice zone, N.Atlantic           
!     integer, parameter :: itest=1,jtest=90    !Equatorial Pacific             
!     integer, parameter :: itest=208,jtest=91    
!     integer, parameter :: itest=153,jtest=125  !N.Atlantic near coast (2layers) 10.62W  34.5N
!     integer, parameter :: itest=120,jtest=120  !N.Atlantic 
      integer, parameter :: itest=126,jtest=104  !N.Atlantic -- off Congo
#else
...
!     integer, parameter :: itest=243, jtest=1      !equator,dateline
      integer, parameter :: itest=185,jtest=310    ! North Atlantic            
      real :: diag_counter
#endif
...
!$OMP THREADPRIVATE(/bkpt/)
      ...
      real A_tend, co3_conc                     !alk tendency (dA/dt)
...
c**** Extract domain decomposition info
     ...
     &            rikd3d(i_0h:i_1h,j_0h:j_1h,kdm,nchl))
      ...
      ALLOCATE(pp2diat_day(i_0h:i_1h,j_0h:j_1h))
      ALLOCATE(pp2diat_day_glob(idm,jdm))
      ALLOCATE(pp2chlo_day(i_0h:i_1h,j_0h:j_1h))
      ALLOCATE(pp2chlo_day_glob(idm,jdm))
      ALLOCATE(pp2cyan_day(i_0h:i_1h,j_0h:j_1h))
      ALLOCATE(pp2cyan_day_glob(idm,jdm))
      ALLOCATE(pp2cocc_day(i_0h:i_1h,j_0h:j_1h))
      ALLOCATE(pp2cocc_day_glob(idm,jdm))
      ...
      ALLOCATE(pp2diat_dayav(idm,jdm))
      ALLOCATE(pp2diat_dayav_loc(i_0h:i_1h,j_0h:j_1h))
      ALLOCATE(pp2chlo_dayav(idm,jdm))
      ALLOCATE(pp2chlo_dayav_loc(i_0h:i_1h,j_0h:j_1h))
      ALLOCATE(pp2cyan_dayav(idm,jdm))
      ALLOCATE(pp2cyan_dayav_loc(i_0h:i_1h,j_0h:j_1h))
      ALLOCATE(pp2cocc_dayav(idm,jdm))
      ALLOCATE(pp2cocc_dayav_loc(i_0h:i_1h,j_0h:j_1h))
      ...
      ALLOCATE(pHav(idm,jdm))
      ALLOCATE(pHav_loc(i_0h:i_1h,j_0h:j_1h))
#endif
...
!------------------------------------------------------------------------------
      ...
      call pack_data( ogrid, pp2diat_day, pp2diat_day_glob )
      call pack_data( ogrid, pp2chlo_day, pp2chlo_day_glob )
      call pack_data( ogrid, pp2cyan_day, pp2cyan_day_glob )
      call pack_data( ogrid, pp2cocc_day, pp2cocc_day_glob )
