...
!@var TAUSS_FIX_MET optical depth from super-saturated clouds
      REAL*8, ALLOCATABLE, DIMENSION(:,:,:) :: TAUSS_FIX_MET
!@var TAUMC_FIX_MET optical depth from moist-convective clouds
      REAL*8, ALLOCATABLE, DIMENSION(:,:,:) :: TAUMC_FIX_MET
!@var CSIZMC,CSIZSS mc,ss effective cloud droplet radius (microns)
      REAL*8, ALLOCATABLE, DIMENSION(:,:,:) :: csizmc_fix_met
      REAL*8, ALLOCATABLE, DIMENSION(:,:,:) :: csizss_fix_met
#endif
...
!@var UKM,VKM arrays for vertical momentum mixing
      ...
      REAL*8, ALLOCATABLE, DIMENSION(:)  :: DIURN_MCLWC
#endif
#endif

C**** ISCCP diagnostics related parameter
#ifdef SCM
      INTEGER, parameter, public :: ncol = 100    !@var ncol number of subcolumns
#else
      INTEGER, parameter, public :: ncol = 20    !@var ncol number of subcolumns
#endif
#ifdef CFMIP
!@dbparam Nsubdd_for_cfmip: sub-daily diag freq for CFMIP/COSP
      INTEGER :: Nsubdd_for_cfmip
#endif
...
#endif
#ifdef CLD_ALB_FIX_MET
     *      TAUSS_FIX_MET(LM,I_0H:I_1H,J_0H:J_1H),
     *      TAUMC_FIX_MET(LM,I_0H:I_1H,J_0H:J_1H),
     *     CSIZMC_FIX_MET(LM,I_0H:I_1H,J_0H:J_1H),
     *     CSIZSS_FIX_MET(LM,I_0H:I_1H,J_0H:J_1H),
#endif
