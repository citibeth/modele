...
!@calls tropwmo,coszs,coszt, RADPAR:rcompt,RADPAR:rcompx ! writer,writet
     ...
     *     ,kapa
     ...
     &          ,tauwc0,tauic0,KYEARV ! set in radpar block data
...
C     OUTPUT DATA
     ...
     *     ,albsn_yr,dALBsnX,depoBC,depoBC_1990,volc_yr,AX_rad_save
     *     ,cosz2
#ifdef TRACERS_DUST
     ...
     *     ,n_OCIA,N_OCII,n_so4_d1,n_so4_d2,n_so4_d3,trpdens,n_SO4
     *     ,n_OCI1,n_OCI2,n_OCI3,n_OCA1,n_OCA2,n_OCA3,n_OCA4
#ifdef TRACERS_AEROSOLS_Koch
     *     ,SNFST0,TNFST0
#endif
      USE TRACER_DIAG_COM, only: taijs,ijts_fc,ijts_tau,ijts_tausub
     &     ,ijts_fcsub,ijts_3dtau,ijts_sqex,ijts_sqexsub,ijts_sqsc
     &     ,ijts_sqscsub,ijts_sqcb,ijts_sqcbsub,diag_rad
#endif
      IMPLICIT NONE
C
...
!@+   which ntrace fields are not defined
     ...
     *     ,tauex5,tauex6,tausct,taugcb,dcdnc,wtt
