...
C to define BrOx, ClOx,ClONOs,HCL,OxIC,CFCIC,N2OICX,CH4ICX as well (GSF):
...
#endif
      REAL*8, DIMENSION(IM,JM,LCOalt) :: OxICIN,CH4ICIN
#ifdef SHINDELL_STRAT_CHEM
     &                                  ,N2OICIN,CFCICIN
#endif
...
#ifdef SHINDELL_STRAT_CHEM
      REAL*8, DIMENSION(IM,JM,LM)       :: SF3,SF2
...
#ifdef SHINDELL_STRAT_CHEM
      COMMON/SCHEM_LOC/ratioNs,rNO2frac,rNOfrac,rNOdenom,
     &                 ratioN2
