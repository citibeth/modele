...
CCC#ifdef SHINDELL_STRAT_CHEM
CCC     bz=(ss(2,L,I,J)+ss(28,L,I,J)*y(n_N2O,L)/y(n_Ox,L))/
CCC  &  (rr(8,L)*y(nO2,L)+rr(9,L)*y(nM,L)+
CCC  &  rr(10,L)*y(nH2O,L)+rr(11,L)*y(n_CH4,L) +
CCC  &  (rr(86,L)+rr(87,L))*y(n_N2O,L) )
CCC#else
        bz=ss(2,L,I,J)/
     &  (rr(8,L)*y(nO2,L)+rr(9,L)*y(nM,L)+
     &  rr(10,L)*y(nH2O,L)+rr(11,L)*y(n_CH4,L))
C       test O1D amount:
        if(l.gt.LS1)bz=bz*1.d1
CCC#endif
        P1=1./(1.+az+bz)
...
C
       bqqz=pHOx(I,J,L)*(rr(12,L)*y(n_CH4,L)+rr(16,L)*
     & y(n_HNO3,L)
c     & +rr(23,L)*y(n_CH3OOH,L) !test w/o HCs
     & +rr(iHNO3form,L)*y(nNO2,L)+rr(iHONOform,L)*y(nNO,L))
c     &  +rr(22,L)*yCH3O2(I,J,L) !test w/o HCs
...
c     &+ ss(13,L,i,j)*y(n_HCHO,L) !test w/o HCs
...
c     &  rr(10,L)*y(nH2O,L)+rr(11,L)*y(n_CH4,L))
     ...
     &  +SF3(I,J,L)*y(nH2O,L) !water vapor photolysis in SRBs
c     &  +rr(85,L)*y(nClO,L)*y(nCH3O2,L) !test w/o HCs
c     &  + rr(20,L)*y(nNO,L)*y(nCH3O2,L) !test w/o HCs
