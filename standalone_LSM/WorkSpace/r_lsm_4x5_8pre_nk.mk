# r_lsm_4x5_8pre_nk.mk
# rundeck for compiling stand-alone version of GISS LSM
# coupled to Ent with FBB photosynthesis for 4x5 resolution.
# OPTS_giss_LSM_standalone LSM_DRV=GLOBAL compiles with modules 
# lsm_standalone_nk.f, drv_met_gswp_nk.f,
# drv_veg.f, and lsm_phys_util.f.
# - Matthews 8 vegetation types and prescribed or prognostic LAI.
# - GSWP2 meterological forcings
