...
OPTS_Ent = PS_MODEL=FBB PFT_MODEL=ENT FLUXNET=YES ENT_STANDALONE_DIAG=YES MIXED_CANOPY_OPT=YES
OPTS_Ent_standalone = PFT_MODEL=ENT ENT_STANDALONE_DIAG=YES MIXED_CANOPY_OPT=YES
#OPTS_giss_LSM = USE_ENT=YES  
OPTS_shared =
#OPTS_giss_LSM_standalone = USE_ENT=YES    

DATADIR=/raid8/Entdata/Tonzi/Siteforcings_6layer
DATADIR_veg=/raid8/Entdata/Tonzi/Siteforcings_veg16

INPUT_FILES = \
ENTSTRUCT=$(DATADIR_veg)/Entstruct_tonzi16.csv \
...
W5=$(DATADIR)/W5.Tonzi \
W6=$(DATADIR)/W6.Tonzi \
LAIMIXED=$(DATADIR_veg)/LAIMIXED.Tonzi16 \
HEIGHTMIXED=$(DATADIR_veg)/HEIGHTMIXED.Tonzi16 \
